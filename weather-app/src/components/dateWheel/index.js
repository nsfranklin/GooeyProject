		...
		return (
				...
				<div class={ style.container }>
					...
					{ this.state.display ? <Button number={ "S" }  class={ style_iphone.button } clickFunction={ this.fetchWeatherDataForecast }/ > : null }
						{ this.state.display ? <Button no={-3} number{10 }  class={ style_iphone.button } clickFunction={ this.fetchWeatherDataHistory } onClick={this.handleClick}/ > : null }
